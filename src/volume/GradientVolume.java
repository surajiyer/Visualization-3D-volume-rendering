...
//                    float gx = volume.getVoxel(i+1, j, k) - volume.getVoxel(i, j, k);
//                    float gy = volume.getVoxel(i, j+1, k) - volume.getVoxel(i, j, k);
//                    float gz = volume.getVoxel(i, j, k+1) - volume.getVoxel(i, j, k);
